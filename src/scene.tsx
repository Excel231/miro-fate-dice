    ...
    {activeTab === 'sheet' ? <>
      ...
      <div className="character-sheet__columns scene-sheet__columns">
        ...
        <div className="character-sheet__column">
          ...
          <section className="sheet-section scene-sheet__notes"><h2>{copy.notes}</h2><label className="character-field"><textarea rows={12} placeholder={copy.notesPlaceholder} value={state.notes} onChange={(event) => update((current) => ({...current, notes: event.target.value}))} /></label></section>
        </div>
      </div>
